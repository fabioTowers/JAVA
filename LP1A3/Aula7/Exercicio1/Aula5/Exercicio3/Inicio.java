...
public class inicio {
	...
	public static void main(String[] args) {
		...
		Integer aux = 5; //Usada para armazenar 1 para PF  ou 2 para PJ na opção cadastrar cliente (valor informado pelo usuário)
		Integer aux2 = 5; //Usada para armazenar 1 para PF  ou 2 para PJ na opção remover cliente (valor informado pelo usuário)
		...
		while(opcao != 0) {//menu inicial
			...
			try {
				opcao = in.nextInt();
				in.nextLine();//Caso ocorra um erro, essa linha não será executada, ainda assim é necessário limpar o buffer...
			} catch (InputMismatchException e) {
				System.out.println("A opção digitada é inválida!");
			} finally {
				in.nextLine();//...no caso de erro o buffer é limpo aqui.
			}
